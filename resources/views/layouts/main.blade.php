...
>
  <head>
    ...
    <link rel="stylesheet" href="{{ asset('assetss/vendor/libs/apex-charts/apex-charts.css') }}" />
    <!-- Page CSS -->
    <!-- Helpers -->
  ...
  <body>
        ...
        <div class="layout-page">
          ...
          >
            ...
            <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
                @include('pages.titlenav')
              <ul class="navbar-nav flex-row align-items-center ms-auto">
                <!-- User -->
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                      <img src="{{ asset('assets/images/userpic.png') }}" alt class="w-px-40 h-auto rounded-circle" />
                    </div>
                  </a>
    ...
    <!-- Vendors JS -->
    <script src="{{ asset('assetss/vendor/libs/apex-charts/apexcharts.js') }}"></script>

    <!-- Main JS -->
    <script src="{{ asset('assetss/js/main.js') }}"></script>

    <!-- Page JS -->
    <script src="{{ asset('assetss/js/dashboards-analytics.js') }}"></script>
